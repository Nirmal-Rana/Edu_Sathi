...
namespace EduSathi.Migrations
{
    ...
    [Migration("20260919091242_AddFriendsAndQuestionCount")]
    partial class AddFriendsAndQuestionCount
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduSathi.Models.FriendRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EduSathi.Models.FriendRequest", b =>
                {
                    b.HasOne("EduSathi.Models.ApplicationUser", "Addressee")
                        .WithMany()
                        .HasForeignKey("AddresseeUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("EduSathi.Models.ApplicationUser", "Requester")
                        .WithMany()
