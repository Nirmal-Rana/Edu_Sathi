...
namespace EduSathi.Services
{
    public class GeminiService
    {
        ...
        public GeminiService(HttpClient httpClient, IConfiguration config)
        {
            ...
            // Increase HttpClient timeout from default 100 seconds to 200 seconds
    ...
    Provide the output in a clear JSON array format or structured text containing the question, options A, B, C, D, the correct answer, and a short explanation.
